...
export default function Home({ onSubmit }) {
  ...
  return (
    <div
      className="home"
      style={{
        background: `url(${process.env.PUBLIC_URL + "/media/home.jpg"})`,
      }}
    >
      <div className="container">
        ...
        <div className="home-contant">
          ...
          <div className="hero-slider d-flex align-content-center">
            <img
              src={process.env.PUBLIC_URL + "/media/Image-bg.png"}
              className="img-fluid position-absolute mt-20 pt-3"
              alt=""
            />
