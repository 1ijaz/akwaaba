...
export default function TravelDetail({ destination, date, onSubmit }) {
  ...
  const handleRegenerate = () => {
    // Call handleSubmit function passed from App component
      ...
      .post(
        "https://api.openai.com/v1/chat/completions",
        {
          ...
          messages: [
            {
              role: "user",
              content: "what is the location of" + destination + "in 2 lines",
            },
          ],
        },
        {
          headers: {
            ...
            Authorization: `Bearer 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`,
          },
        }
      )
      .then((response) => {
          ...
          messages: [
            {
              role: "user",
              content:
                "write something about the weather of" +
                destination +
                "in 2 lines",
            },
          ],
          ...
          messages: [
            {
              role: "user",
              content:
                "write something about the price of" +
                destination +
                "in 2 lines",
            },
          ],
          ...
          messages: [
            {
              role: "user",
              content:
                "write something about the language of" +
                destination +
                "in 1 line",
            },
          ],
    ...
    if (totalDays > 0) {
      ...
      axios
            ...
            messages: [
              {
                ...
                content:
                  "Generate a " +
                  totalDays +
                  "-day trip roadmap for a visit to" +
                  destination +
                  "in days with every day main heading and with morning afternoon and evening schedule",
              },
        ...
        .then((res) => {
          ...
          const splitMessages = assistantMessage
            .split(/Day \d+:/)
            .filter((day) => day.trim() !== "");
    ...
    <>
      <div className="travel-detail">
        <div className="container">
          <div className="cus-header d-flex justify-content-between align-items-center pt-20">
            <img
              src={process.env.PUBLIC_URL + "/media/logo-dark.png"}
              className="h-40px"
              alt=""
            />
            <div className="d-flex gap-3">
              {/* <button className="btn btn-secondary d-none d-sm-block">
                <img
                  src={process.env.PUBLIC_URL + "/media/icons_google.svg"}
                  className="me-2"
                  alt=""
                />
                Sign in with Google
          ...
          <div className="hero-wrapper">
            <h1 className="mb-7">
              {totalDays}-Day {destination} Adventure
            </h1>
            <div
              className="hero-header-wrapper"
              style={{
                background: `linear-gradient(0deg, rgba(0, 0, 128, 0.24) 0%, rgba(0, 0, 128, 0.24) 100%), url(${
                  process.env.PUBLIC_URL + "/media/detail-hero.jpg"
              ...
              <div className="col-lg-3 col-md-6 col-12 mb-lg-0 mb-5 px-md-9 px-5">
                <div className="card shadow h-100">
                  <div className="card-header px-6 border-gray-400 d-flex justify-content-between align-items-center">
                    ...
                    <img
                      src={process.env.PUBLIC_URL + "/media/mdi_location.svg"}
                      className="me-2"
                      alt=""
                    />
                  </div>
                  ...
                  <div className="card-header px-6 border-gray-400 d-flex justify-content-between align-items-center">
                    ...
                    <img
                      src={
                        ...
                        "/media/fluent_weather-haze-48-regular.svg"
                      }
                      className="me-2"
                      alt=""
                    />
              ...
              <div className="col-lg-3 col-md-6 col-12 mb-lg-0 mb-5 px-md-9 px-5">
                <div className="card shadow h-100">
                  <div className="card-header px-6 border-gray-400 d-flex justify-content-between align-items-center">
                    ...
                    <img
                      src={process.env.PUBLIC_URL + "/media/$.svg"}
                      className="me-2"
                      alt=""
                    />
                  </div>
                ...
                <div className="card shadow h-100">
                  <div className="card-header px-6 border-gray-400 d-flex justify-content-between align-items-center">
                    ...
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        "/media/clarity_language-line.svg"
                      }
                      className="me-2"
                      alt=""
                    />
      ...
      {loading ? ( // Conditionally render loader or TravelResult based on loading state
        <div className="loader d-flex justify-content-center">
          <img
            src={process.env.PUBLIC_URL + "/media/loader.gif"}
            className="h-sm-400px my-10"
            alt=""
          />
        </div>
      ) : (
        <>
          {days.map((day, index) => (
            <TravelResult
              ...
              myTest={day}
              division={day
                .split(/\b(Morning|Afternoon|Evening)\b/)
